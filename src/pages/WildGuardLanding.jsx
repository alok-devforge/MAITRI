...
  const mockAlerts = [
    { type: "Elephant Herd", location: "Near Village Kumara, 2km NE", time: "5 min ago", severity: "high" },
    { type: "Tiger", location: "Forest Road Junction", time: "12 min ago", severity: "medium" },
    { type: "Bear", location: "Riverside Trail", time: "25 min ago", severity: "medium" },
  ];
...
                  Live Alerts
                </h3>
                <AlertCard {...mockAlerts[currentAlert]} />
              </div>
